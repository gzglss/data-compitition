...
FINETUNED_BERT_ENCODER_PATH = '../model/bert_model/finetuned_bert.bin'
...
PRETRAINED_BERT_ENCODER_PATH = '../model_pre/bert_base_chinese/'
BERT_MODEL_SAVE_PATH = '../model/bert_model/'
BATCH_SIZE = 16
EPOCH = 3
...
def train_bert():
    ...
    for epoch in range(EPOCH):
        model_save_path = os.path.join(BERT_MODEL_SAVE_PATH, "bert_model_epoch{}.pkl".format(epoch))
