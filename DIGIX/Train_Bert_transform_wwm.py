...
from bertwwm_transform_classification import BertClassificationModel

# Bert预训练模型
INDEX = ['人物专栏', '作品分析', '情感解读', '推荐文', '攻略文', '治愈系文章', '深度事件', '物品评测', '科普知识文', '行业解读']
FINETUNED_BERT_ENCODER_PATH = '../model/bertwwm/finetuned_bertwwm.bin'
...
PRETRAINED_BERT_ENCODER_PATH = '../model_pre/bert_chinese_wwm'
BERT_MODEL_SAVE_PATH = '../model/bertwwm/'
BATCH_SIZE = 16
EPOCH = 3
...
def train_bertwwm():
    ...
    for epoch in range(EPOCH):
        model_save_path = os.path.join(BERT_MODEL_SAVE_PATH, "bertwwm_model_epoch{}.pkl".format(epoch))
